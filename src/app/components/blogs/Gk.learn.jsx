...
function CodeBlock({ code, language = "javascript" }) {
  ...
  return (
    <div className="relative">
      <button
        onClick={handleCopy}
        className="absolute p-2 transition-colors bg-gray-800 rounded top-3 right-3 hover:bg-gray-700 dark:bg-gray-700 dark:hover:bg-gray-600"
...
\`;
  ...
  return (
    <article className="min-h-screen text-black bg-white dark:bg-gray-900 dark:text-gray-100">
      <div className="max-w-4xl px-6 py-12 mx-auto">
        ...
        <section className="mb-12">
          <p className="mb-4 text-lg leading-relaxed text-black dark:text-gray-300">
        ...
        {/* Prerequisites */}
        <section className="mb-12">
          <h2 className="flex items-center gap-3 mb-6 text-3xl font-bold text-black dark:text-white">
        ...
        <section className="mb-12">
          ...
          <div className="space-y-4">
            <div>
              <h3 className="mb-3 text-xl font-semibold text-black dark:text-gray-200">
                macOS
              </h3>
              <CodeBlock code="brew install k6" />
            </div>
            <div>
              <h3 className="mb-3 text-xl font-semibold text-black dark:text-gray-200">
                Windows
              </h3>
              <CodeBlock code="choco install k6" />
            </div>
            <div>
              <h3 className="mb-3 text-xl font-semibold text-black dark:text-gray-200">
                Linux
              </h3>
              <CodeBlock code="sudo apt-get install k6" />
            </div>
          </div>
        </section>
        ...
        <section className="mb-12">
          ...
          <CodeBlock code="k6 run load-test.js" />
          <p className="mt-4 text-black dark:text-gray-300">
            For stage-specific testing:
          </p>
          <CodeBlock code="k6 run -e STAGE=2 load-test.js" />
        </section>
        ...
        <section className="mb-12">
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="p-6 border border-blue-200 rounded-lg bg-blue-50 dark:from-gray-800 dark:to-gray-700 dark:border-gray-600 dark:bg-gray-800">
              <h3 className="flex items-center gap-2 mb-3 text-xl font-semibold text-black dark:text-white">
                <Code className="w-5 h-5 text-blue-600 dark:text-blue-400" />
                HTML/CSS/JS Report
              </h3>
              <p className="mb-3 text-sm text-black dark:text-gray-300">
            ...
            <div className="p-6 border border-green-200 rounded-lg bg-green-50 dark:from-gray-800 dark:to-gray-700 dark:border-gray-600 dark:bg-gray-800">
              <h3 className="flex items-center gap-2 mb-3 text-xl font-semibold text-black dark:text-white">
        ...
        <section className="mb-12">
          ...
          <div className="p-6 border border-yellow-200 rounded-lg bg-yellow-50 dark:from-gray-800 dark:to-gray-700 dark:border-gray-600 dark:bg-gray-800">
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
        ...
        <section className="mb-12">
          ...
          <p className="mb-4 leading-relaxed text-black dark:text-gray-300">
