          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
            ...
            >
              ...
              <motion.button
                ...
                whileTap={{ scale: 0.9 }}
                onClick={onClose}
                className="absolute z-10 p-2 text-black transition-colors bg-gray-100 rounded-full top-4 right-4 dark:bg-gray-900 dark:text-white hover:bg-gray-200 dark:hover:bg-gray-800"
              >
                <X className="w-5 h-5" />
              </motion.button>
