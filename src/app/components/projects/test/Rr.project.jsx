...
export const projectMeta = {
  slug: 'rr-crop',
  title: 'RrCrop',
  shortDesc: 'Comprehensive QA testing & automation for task management with advanced project allocation',
  description:
  ...
  category: 'Testing',
  githubUrl: 'https://github.com/GyanaprakashKhandual/RR-Crop-Project-Gantt-Chart.git',
  techStack: [
    'Cypress',
    'Page Object Model',
    'Cucumber',
    ...
    <div className="space-y-8">
      ...
      <section>
        ...
        <div className="space-y-4 leading-7 text-gray-700 dark:text-slate-300">
          <p>
            RrCrop is an advanced task management application designed for complex project allocation and
            resource management. I performed comprehensive QA testing across all layers of the application,
            ensuring reliable functionality for task scheduling, team collaboration, and performance under
            heavy loads.
          </p>

          <div>
            <h4 className="mb-3 font-semibold text-black dark:text-white">Testing Coverage:</h4>
          ...
          <div>
            ...
            <ul className="ml-4 space-y-2">
              ...
              <li>• Custom HTML/CSS/JavaScript Reports - Interactive dashboards</li>
          ...
          <p className="mt-4 font-semibold text-black dark:text-white">
            The testing strategy encompasses end-to-end functional testing across multiple themes, rigorous
            API validation using Postman with detailed assertions, and comprehensive performance testing with
            JMeter to ensure optimal response times under various load conditions. The Cypress automation
            framework, combined with Page Object Model architecture, provides robust and maintainable test suites
            that validate complex task allocation workflows and team resource management scenarios.
          </p>
        </div>
      </section>
      ...
      <section>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2">
          {[
            { title: 'Task Management', desc: 'Task creation, assignment, tracking, and completion workflows' },
            { title: 'Project Allocation', desc: 'Resource distribution, project setup, team assignment' },
            { title: 'Workman Management', desc: 'Workman assignment, skill mapping, availability tracking' },
            { title: 'Staff Management', desc: 'Staff roles, permissions, performance metrics' },
            { title: 'Access Control', desc: 'Role-based access, permissions hierarchy, security policies' },
            { title: 'API Integration', desc: 'Custom API endpoints, data synchronization, third-party integration' },
            { title: 'Multi-theme Testing', desc: 'Theme switching, UI consistency, responsive design' },
            { title: 'Performance & Load', desc: 'JMeter load testing, response times, concurrent users' },
          ].map((domain) => (
            <div
              key={domain.title}
      ...
      <section>
        ...
        <div className="space-y-3">
          {[
            ...
            <div key={i} className="flex items-start gap-3 p-3 rounded-lg bg-gray-50 dark:bg-slate-900">
              <CheckCircle className="w-5 h-5 text-black dark:text-white shrink-0 mt-0.5" />
              <span className="text-sm text-gray-700 dark:text-slate-300">{capability}</span>
            </div>
          ))}
        </div>
      </section>
