...
const socialLinks = [
    {
        name: 'Gmail',
        icon: Mail,
        url: 'mailto:gyanaprakashk@gmail.com',
        handle: 'gyanaprakashk@gmail.com'
    },
    {
        name: 'LinkedIn',
        icon: Linkedin,
        url: 'https://linkedin.com/in/gyan',
        handle: '@gyan'
    },
    {
        name: 'GitHub',
        icon: Github,
        url: 'https://github.com/gyan',
        handle: '@gyan'
    },
    {
        name: 'Instagram',
        icon: Instagram,
        url: 'https://instagram.com/gyan',
        handle: '@gyan'
    }
];
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setStatus('error');
                setStatusMessage(data.message || 'Failed to send email. Please try again.');
            }
        } catch (error) {
            setStatus('error');
            ...
            >
                <div className="text-center">
                    ...
                    <p className="max-w-2xl mx-auto text-lg text-gray-700 sm:text-xl dark:text-gray-300">
                        Have a question or project in mind? I'd love to hear from you. Let's connect and create something amazing together.
                    </p>
                </div>
            </motion.div>
                    ...
                    <motion.div variants={itemVariants} className="lg:col-span-1">
                        ...
                        >
                            ...
                            <div className="pb-8 mb-8 space-y-4 border-b border-gray-300 dark:border-gray-700">
                                ...
                                >
                                    <MapPin className="w-5 h-5 text-black dark:text-white flex-shrink-0 mt-0.5" />
                                    <div>
                                ...
                                <motion.div
                                    ...
                                    className="flex items-start gap-3"
                                >
                                    <Phone className="w-5 h-5 text-black dark:text-white flex-shrink-0 mt-0.5" />
                                    <div>
                                        <p className="mb-1 text-xs font-semibold tracking-wider text-gray-600 uppercase dark:text-gray-400">
                                            Phone
                                        </p>
                                ...
                                <motion.div
                                    ...
                                    className="flex items-start gap-3"
                                >
                                    <Mail className="w-5 h-5 text-black dark:text-white flex-shrink-0 mt-0.5" />
                                    <div>
                                        <p className="mb-1 text-xs font-semibold tracking-wider text-gray-600 uppercase dark:text-gray-400">
                                            Email
                                        </p>
                        ...
                        >
                            <div className="space-y-6">
                                ...
                                <motion.div variants={itemVariants}>
                                    <label htmlFor="name" className="block mb-2 text-sm font-semibold text-black dark:text-white">
                                ...
                                {/* Email Field */}
                                <motion.div variants={itemVariants}>
                                    <label htmlFor="email" className="block mb-2 text-sm font-semibold text-black dark:text-white">
                                ...
                                {/* Subject Field */}
                                <motion.div variants={itemVariants}>
                                    <label htmlFor="subject" className="block mb-2 text-sm font-semibold text-black dark:text-white">
                                ...
                                {/* Message Field */}
                                <motion.div variants={itemVariants}>
                                    <label htmlFor="message" className="block mb-2 text-sm font-semibold text-black dark:text-white">
