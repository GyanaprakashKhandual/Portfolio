...
const experiences = [
    {
        ...
        description: 'Led comprehensive QA and testing initiatives across multiple platforms',
        highlights: [
        ...
        skills: ['Manual Testing', 'Automation Testing', 'BDD Cucumber', 'CI-CD', 'API Testing', 'Performance Testing', 'Grafana', 'Postman']
    },
    {
        company: 'Avidus Interactive',
        position: 'Product Designer & SDET',
        duration: 'October 2025 - Present',
        description: 'Architect complete product design and quality assurance strategy',
        highlights: [
        ...
        skills: ['Product Design', 'UI/UX Design', 'SDET', 'Frontend Architecture', 'Backend Design', 'Security', 'Team Leadership', 'System Design']
    }
];
            ...
            >
                <div className="text-center">
                    ...
                    <p className="max-w-2xl mx-auto text-lg text-gray-700 sm:text-xl dark:text-gray-300">
                        A journey of quality assurance excellence, product design innovation, and team leadership across dynamic organizations
                    </p>
                </div>
            </motion.div>
                                    ...
                                    <div className="flex items-start justify-between mb-4">
                                        <div className="flex items-start flex-1 gap-4">
                                            <motion.div
                                                ...
                                                className="flex-shrink-0 p-3 text-white bg-black rounded-lg dark:bg-white dark:text-black"
                                            >
                                        ...
                                        <div className="pt-6 mt-6 border-t border-gray-300 dark:border-gray-700">
                                            ...
                                            <ul className="mb-6 space-y-3">
                                                {exp.highlights.map((highlight, i) => (
                                                    ...
                                                    >
                                                        <ArrowRight className="flex-shrink-0 w-4 h-4 mt-1 text-black dark:text-white" />
